...
public class UserController
{
    ...
    @PreAuthorize("hasAuthority('ROLE_ADMIN')") //technically any user can see but don't want other user to
    @GetMapping(value = "/user/{userId}",       //so lock endpoint to role via preauth
                produces = {"application/json"})
